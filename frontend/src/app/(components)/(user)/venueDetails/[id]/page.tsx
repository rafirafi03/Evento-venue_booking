      ...
      <div className="mx-auto px-6 max-w-7xl items-center justify-center p-6 rounded-lg">
        ...
        <div className="flex max-w-full my-auto mt-5">
          ...
          <div className="w-1/4 p-6 ml-5 right-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <a
              className="block my-3 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
            >
            ...
            <p className="text-sm font-bold">
              good for wedding functions. we provide a user friendly services
              with experienced staffs who have more than 1 year of experience in
              this field. this make this venue more aptable for your funcitons.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <h3 className="text-sm font-bold my-2">
            celebrarte you function with amaltas
          </h3>
