              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Date: {new Date(booking?.bookingDateStart).toLocaleDateString()} to {new Date(booking?.bookingDateEnd).toLocaleDateString()}</span>
                    </div>
                    { booking?.status == "confirmed" ? (
                      ...
                      <span>Staus: <span className="text-success-600">{booking?.status}</span></span>
                    </div>
                    </>
                    ) : (
                        <div className="flex items-center">
                        <XCircle className="w-5 h-5 mr-2 text-red-600" />
                        <span>Staus: <span className="text-danger-500">{booking?.status}</span></span>
                      </div>
                    )} 
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <button
                      onClick={() =>
                        router.push(`/company/venueDetails/${booking?.venueId._id}`)
                      }
