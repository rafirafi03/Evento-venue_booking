...
export default function Page({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async () => {
    ...
    if(name.trim() == "") {
      ...
      setNameError('alteast 3 character required!');
      isValid = false;
    }
    ...
    if(type.trim() == "") {
      ...
      setTypeError('alteast 3 character required!');
      isValid = false;
    }
    ...
    if(description.trim() == "") {
      ...
      setDescriptionError('alteast 10 character required!');
      isValid = false;
    }
    ...
    if(address.trim() == "") {
      ...
      setAddressError('atleast 3 characters required!!')
      isValid = false
    }
    ...
    if(city.trim() == "") {
      ...
      setCityError('atleast 3 characters required!!')
      isValid = false
    }
    ...
    if(state.trim() == "") {
      ...
      setStateError('atleast 3 characters required!!')
      isValid = false
    }
