      ...
      <div className="flex mt-[64px]">
        ...
        <div className="flex-1 p-4 space-y-5 bg-slate-100 sm:p-6 md:space-y-6 lg:p-8 mt-5">
          <div className="flex items-center justify-center gap-4 sm:space-x-1 md:space-x-6 lg:space-x-8">
            ...
            <RevenueCard title={'Month Revenue'} data={dashboardData?.monthlyRevenue} />
            <RevenueCard title={'Year Revenue'} data={dashboardData?.yearlyRevenue} />
            <RevenueCard title={'Overall Revenue'} data={dashboardData?.overallRevenue} />
          </div>
