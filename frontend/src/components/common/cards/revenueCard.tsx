...
export default function revenueCard({title, data}: pageProps) {
  return (
    <div className="block max-w-sm p-4 sm:p-6 lg:p-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 sm:max-w-md lg:max-w-lg">
