...
import { MakePaymentUseCase, WebhookUseCase, GetUserBookingsUseCase, CancelBookingUseCase, GetCompanyBookingsUseCase } from "../../useCases";
...
const getCompanyBookingsUseCase = new GetCompanyBookingsUseCase(bookingRepository)
const cancelBookingUseCase = new CancelBookingUseCase(bookingRepository)

const bookingController = new BookingController(makePaymentUseCase, webhookUseCase, getBookingsByUserId, getCompanyBookingsUseCase, cancelBookingUseCase);
