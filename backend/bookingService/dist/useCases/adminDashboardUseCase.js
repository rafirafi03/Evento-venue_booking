    ...
    async execute() {
        try {
            ...
            const lastFiveYearRevenue = Array.from({ length: 5 }, (_, i) => currentYear - i)
                ...
                const totalSales = filteredBookings?.reduce((total, booking) => total + (booking.venueDetails?.amount * 0.05 || 0), 0) || 0;
            ...
            const last7DaysSales = Array.from({ length: 7 }, (_, i) => {
                ...
                const sales = bookings
                    ...
                    .reduce((total, booking) => total + (booking.venueDetails.amount * 0.05 || 0), 0);
